    ...
    return e.prototype = {
        ...
        jsFontsKey: function(e, t) {
            ...
            return setTimeout(function() {
                ...
                for (var x = 0, v = a.length; x < v; x++)
                    d[a[x]] = S[x].offsetWidth,
                    c[a[x]] = S[x].offsetHeight;
                var M = m();
                l.appendChild(u);
                for (var E = [], A = 0, y = r.length; A < y; A++)
                    T(M[r[A]]) && E.push(r[A]);
                l.removeChild(u),
                l.removeChild(h),
                e.push({
        ...
        getWebglFp: function() {
            ...
            try {
                ...
                d && (a.push("webgl unmasked vendor:" + e.getParameter(d.UNMASKED_VENDOR_WEBGL)),
                a.push("webgl unmasked renderer:" + e.getParameter(d.UNMASKED_RENDERER_WEBGL)))
            } catch (c) {}
...
(function() {
    ...
    var APPID = null
    try {
        APPID = document.getElementsByName('pocket_pa')[0].attributes.aid.nodeValue
    } catch (e) {
        console.log(e)
    }
    ...
    utils.data = function(opts) {
        _majax({
            ...
            data: {
                ...
                app_id: opts.app_id || this.APPID,
                vid: this.vid,
                state: opts.state || 1,
                //1首次   //2跳转   //3关闭
                uuid: opts.uuid || window._$pocket_uuid
            },
...
try {
    new Fingerprint2().get(function(result, components) {
        window._$pocket_uuid = result

        // 进入页面
        window.POCKETA.data({
            state: 1,
            url: location.href,
            uuid: window._$pocket_uuid
        })
...
(function() {
    ...
    mta.setAttribute("sid", "500469881");
